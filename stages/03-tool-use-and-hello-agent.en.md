...
- [**microsoft/ai-agents-for-beginners**](https://github.com/microsoft/ai-agents-for-beginners) — Microsoft's official 12-lesson intro to building AI agents (MIT, ★ 71k+). Structured, English, with code; a parallel beginner course, not a substitute for this stage's hands-on exercises.
